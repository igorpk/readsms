 ...
 */
public class UploadQueueDbHelper extends SQLiteOpenHelper {
    ...
    //default constructor
    public UploadQueueDbHelper(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    //default constructor
    public UploadQueueDbHelper(Context context, DatabaseErrorHandler errorHandler) {
